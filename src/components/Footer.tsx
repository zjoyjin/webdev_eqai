...
export default function Footer({ locale }: FooterProps) {
  ...
  const assessmentLinks = [
    { href: `/${locale}/work`, label: t('home.categories.work.title') },
    { href: `/${locale}/personal`, label: t('home.categories.personal.title') },
    { href: `/${locale}/kid`, label: t('home.categories.kid.title') },
    { href: `/${locale}/pet`, label: t('home.categories.pet.title') },
  ];
