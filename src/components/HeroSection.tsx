      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
            <div className="aspect-[4/3] bg-gradient-to-br from-primary-100 via-lavender-100 to-teal-100 rounded-2xl shadow-2xl overflow-hidden border border-white/50">
              <Image
                src="/logo.jpeg"
                alt={t('imageAlt')}
                fill
